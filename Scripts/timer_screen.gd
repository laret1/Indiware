extends Node2D
@onready var garlic_container: HBoxContainer = $vidacontainer
@onready var garlic: TextureRect = $vidacontainer/Vida
@onready var garlic_2: TextureRect = $vidacontainer/Vida2
@onready var garlic_3: TextureRect = $vidacontainer/Vida3
@onready var garlic_4: TextureRect = $vidacontainer/Vida4
...
# should be next. Make sure you name your minigame saves appropriately.
		...
		get_tree().change_scene_to_file("res://escenas/ganaste.tscn") # changes your scene
